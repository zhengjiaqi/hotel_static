    ...
    if(ua.toLowerCase().indexOf('qunar')==-1 ){
      ...
      function skip(){
        if(ua.toLowerCase().indexOf('micromessenger')!==-1 ){
          ...
          var url ='http://wap.qunarzz.com/fed_download/wap/Qunar_alex_C3788.apk?from=huawei_6';
          location.href = url;
        }else{
